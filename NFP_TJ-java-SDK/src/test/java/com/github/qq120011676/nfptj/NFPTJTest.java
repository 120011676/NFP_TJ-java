...
class NFPTJTest {
    ...
    void waybillTest() throws JAXBException, IOException {
        ...
        body.getConsignorInfo().setConsignorID("托运人统一社会信用代码或个人证件号");
        ...
        body.getVehicleInfo().setReceiptCountrySubdivisionCode("收货地址的国家行政区划代码或国别代码");
        ...
        driverRO.setDrivingLicense("0123456789012345678");
